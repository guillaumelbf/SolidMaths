...
#pragma region Constructor
         ...
         * @param _z Z value
         */
        constexpr Quat(Type _w, Type _x, Type _y, Type _z);
         ...
         * @param _zAxis Z axis
         */
        constexpr Quat(Type _xAxis, Type _yAxis, Type _zAxis);

        /**
         * @brief Create quaternion with euler axis (in radian)
         * @param _vec Vector3 of euler rotation
         */
        constexpr Quat(const Vec3 <Type> &_vec);
...
#pragma region Static Methods
         ...
         */
        static constexpr SelfType
        lerp(const SelfType &_quat1, const SelfType &_quat2, float _ratio, bool shortestPath = true) noexcept;
         ...
         */
        static constexpr SelfType
        nlerp(const SelfType &_quat1, const SelfType &_quat2, float _ratio, bool shortestPath = true) noexcept;
         ...
         */
        static constexpr SelfType
        slerp(const SelfType &_quat1, const SelfType &_quat2, float _ratio, bool shortestPath = true) noexcept;
...
template <typename TYPE = float>
std::ostream & operator<<(std::ostream & inout_stream, Solid::Quat<TYPE> const& _quat)
{
